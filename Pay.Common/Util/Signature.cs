...
namespace Pay.Common.Util
{
 ...
 //               if (null == rsaCsp)
 //               {
 //                   throw new AlipayException("您使用的私钥格式错误，请检查RSA私钥配置" + ",charset = " + charset);
 //               }
 //               if ("RSA2".Equals(signType))
 //               {
 ...
 //               {
 //                   throw new AlipayException("rsaCheck failure:rsaParams=" + parameters);
 //               }
 //           }
 ...
 //           catch (Exception ex)
 //           {
 //               throw new AlipayException("EncryptContent = " + content + ",charset = " + charset, ex);
 //           }
 //       }
 ...
 //           catch (Exception ex)
 //           {
 //               throw new AlipayException("DecryptContent = " + content + ",charset = " + charset, ex);
 //           }
 //       }
